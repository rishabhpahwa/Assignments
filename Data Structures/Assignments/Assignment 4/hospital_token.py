...
def build_max_heap(a):
	...
	for i in range((len(a)/2),-1,-1):
		max_heapify(a,i)
def heapsort(a):
	'''Initially called function. Just for calling the important routines.'''
	build_max_heap(a)
	pop_max(a)
def pop_max(a):
	'''Extracts the max heap element and the re-heapifies the array, adds the new patients, allocate them the locations and finally terminates once the hospital is overloaded.'''
	global size
	if size<1:
